...
public class CashOutEnter : MonoBehaviour
{
    ...
    void Start()
    {
        CashOutManager.BisFeedback()._CashOutEnter = this;
        OpenPanelBtn.onClick.AddListener(() => { UIManager.BisFeedback().FirnUICharm(nameof(CashOutPanel)); });
        UpdateMoney();
    }
    ...
    public void UpdateMoney()
    {
        ...
        MoneyTextAnim = DOTween.To(() => MoneyStart, x => MoneyText.text = x.ToString("F2"), CashOutManager.BisFeedback().Money, 1f);
