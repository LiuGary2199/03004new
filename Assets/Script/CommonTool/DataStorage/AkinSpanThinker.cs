...
public class AkinSpanThinker
{
    ...
    public static void GapLuck(string key, bool value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static bool BisLuck(string key)
    {
        try
        {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GapAttest(string key, string value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static string BisAttest(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GapOught(string key, float value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static float BisOught(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GapFew(string key, int value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static int BisFew(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GapFewReign(string key, int[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static int[] BisFewReign(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GapOughtReign(string key, float[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static float[] BisOughtReign(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GapAttestReign(string key, string[] value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static string[] BisAttestReign(string key)
    {
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GapQuaint2(string key, Vector2 value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Vector2 BisQuaint2(string key)
    {
        Vector2 Vector2;
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GapQuaint3(string key, Vector3 value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Vector3 BisQuaint3(string key)
    {
        Vector3 vector3;
    ...
    /// <param name="key">键</param>
    /// <param name="value">值</param>
    public static void GapProclivity(string key, Quaternion value)
    {
    ...
    /// <param name="key">键</param>
    /// <returns></returns>
    public static Quaternion BisProclivity(string key)
    {
    ...
    public static void GapHeyday(string key, double value)
    {
        PlayerPrefs.SetString(key, value.ToString());
    }

    public static double BisHeyday(string key)
    {
