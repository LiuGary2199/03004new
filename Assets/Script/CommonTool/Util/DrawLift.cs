...
public class DrawLift
{
    public static long Bequest()
    {
        return BisLogically(DateTime.Now);
    }

    public static long BisLogically(DateTime datetime)
    {
    ...
    /// <returns></returns>
    public static string DrawTiltGrower(DateTime dt, string format)
    {
        return dt.ToString(format);
    }

    public static DateTime PhoenixMyDrawTilt(long seconds)
    {
        DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1)); // 当地时区
    ...
    /// <returns></returns>
    public static string PhoenixGrower(long totalTime, string connector = ":")
    {
